...
static uint8_t dithertable[16] = {7, 0, 6, 1, 2, 5, 3, 4, 1, 6, 0, 7, 4, 3, 5, 2};
...
static __inline void GetShadeTransCol(uint16_t *pdest, uint16_t color)
{
	if (bCheckMask && *pdest & 0x8000)
		return;
	...
	if (DrawSemiTrans)
	{
		...
		if (bCheckMask)
		{
			...
			*pdest = (X32PSXCOL(r, g, b)) | lSetMask; // 0x80008000;
			if (ma & 0x80000000)
				*pdest = (ma & 0xFFFF0000) | (*pdest & 0xFFFF);
			if (ma & 0x00008000)
				*pdest = (ma & 0xFFFF) | (*pdest & 0xFFFF0000);
			return;
		}
		*pdest = (X32PSXCOL(r, g, b)) | lSetMask; // 0x80008000;
	}
...
static __inline void GetTextureTransColG_S(uint16_t *pdest, uint16_t color)
{
	int r, g, b;
	uint16_t l;
...
static __inline void GetTextureTransColGX_S(uint16_t *pdest, uint16_t color, int16_t m1, int16_t m2, int16_t m3)
{
	int r, g, b;
...
static __inline void GetTextureTransColGX32_S(uint32_t *pdest, uint32_t color, int16_t m1, int16_t m2, int16_t m3)
{
	int r, g, b;
...
void FillSoftwareAreaTrans(int16_t x0, int16_t y0, int16_t x1, // FILL AREA TRANS
...
void FillSoftwareArea(int16_t x0, int16_t y0, int16_t x1, // FILL AREA (BLK FILL)
...
static __inline bool SetupSections_FT(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3,
...
static __inline bool SetupSections_F4(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3,
...
static __inline bool SetupSections_FT4(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3,
...
void drawPoly4F(int rgb)
{
	...
	if (lx0 > drawW && lx1 > drawW && lx2 > drawW && lx3 > drawW)
		return;
	if (ly0 > drawH && ly1 > drawH && ly2 > drawH && ly3 > drawH)
		return;
	if (lx0 < drawX && lx1 < drawX && lx2 < drawX && lx3 < drawX)
		return;
	if (ly0 < drawY && ly1 < drawY && ly2 < drawY && ly3 < drawY)
		return;
	if (drawY >= drawH)
		return;
	if (drawX >= drawW)
	...
	if (!SetupSections_F4(lx0, ly0, lx1, ly1, lx2, ly2, lx3, ly3))
		return;
...
static void drawPoly4TEx4_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                   ...
                   int16_t ty4, int16_t clX, int16_t clY)
{
	...
	if (x1 > drawW && x2 > drawW && x3 > drawW && x4 > drawW)
		return;
	if (y1 > drawH && y2 > drawH && y3 > drawH && y4 > drawH)
		return;
	if (x1 < drawX && x2 < drawX && x3 < drawX && x4 < drawX)
		return;
	if (y1 < drawY && y2 < drawY && y3 < drawY && y4 < drawY)
		return;
	if (drawY >= drawH)
		return;
	if (drawX >= drawW)
	...
	if (!SetupSections_FT4(x1, y1, x2, y2, x3, y3, x4, y4, tx1, ty1, tx2, ty2, tx3, ty3, tx4, ty4))
		return;
...
static void drawPoly4TEx8_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                       int16_t tx1, int16_t ty1, int16_t tx2, int16_t ty2, int16_t tx3, int16_t ty3, int16_t tx4,
                       int16_t ty4, int16_t clX, int16_t clY)
{
...
static void drawPoly4TD_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                     int16_t tx1, int16_t ty1, int16_t tx2, int16_t ty2, int16_t tx3, int16_t ty3, int16_t tx4,
                     int16_t ty4)
{
                    ...
                    int col3)
{
	...
	if (!SetupSections_GT(x1, y1, x2, y2, x3, y3, tx1, ty1, tx2, ty2, tx3, ty3, col1, col2, col3))
		return;
			...
			if (xmax >= xmin)
			{
				...
				for (j = xmin; j < xmax; j += 2)
				{
					...
					GetTextureTransColGX32_S(
					    (uint32_t *)&psxVuw[(i << 10) + j], psxVuw[clutP + tC1] | ((int)psxVuw[clutP + tC2]) << 16,
...
static void drawPoly4TGEx4_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                        int16_t tx1, int16_t ty1, int16_t tx2, int16_t ty2, int16_t tx3, int16_t ty3, int16_t tx4,
...
static void drawPoly4TGEx8_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                        int16_t tx1, int16_t ty1, int16_t tx2, int16_t ty2, int16_t tx3, int16_t ty3, int16_t tx4,
                        int16_t ty4, int16_t clX, int16_t clY, int col1, int col2, int col3, int col4)
{
...
static void drawPoly4TGD_TRI(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t x3, int16_t y3, int16_t x4, int16_t y4,
                      int16_t tx1, int16_t ty1, int16_t tx2, int16_t ty2, int16_t tx3, int16_t ty3, int16_t tx4,
...
void drawPoly3FT(uint8_t *baseAddr)
{
...
void drawPoly4FT(uint8_t *baseAddr)
{
	uint32_t *gpuData = ((uint32_t *)baseAddr);
	...
	{
	case 0:
		drawPoly4TEx4_TW(lx0, ly0, lx1, ly1, lx3, ly3, lx2, ly2, (gpuData[2] & 0x000000ff),
		                 ((gpuData[2] >> 8) & 0x000000ff), (gpuData[4] & 0x000000ff), ((gpuData[4] >> 8) & 0x000000ff),
		                 (gpuData[8] & 0x000000ff), ((gpuData[8] >> 8) & 0x000000ff), (gpuData[6] & 0x000000ff),
		                 ((gpuData[6] >> 8) & 0x000000ff), ((gpuData[2] >> 12) & 0x3f0),
		                 ((gpuData[2] >> 22) & iGPUHeightMask));
		return;
	case 1:
		drawPoly4TEx8_TW(lx0, ly0, lx1, ly1, lx3, ly3, lx2, ly2, (gpuData[2] & 0x000000ff),
		                 ((gpuData[2] >> 8) & 0x000000ff), (gpuData[4] & 0x000000ff), ((gpuData[4] >> 8) & 0x000000ff),
		                 (gpuData[8] & 0x000000ff), ((gpuData[8] >> 8) & 0x000000ff), (gpuData[6] & 0x000000ff),
		                 ((gpuData[6] >> 8) & 0x000000ff), ((gpuData[2] >> 12) & 0x3f0),
		                 ((gpuData[2] >> 22) & iGPUHeightMask));
		return;
	case 2:
		drawPoly4TD_TW(lx0, ly0, lx1, ly1, lx3, ly3, lx2, ly2, (gpuData[2] & 0x000000ff),
		               ((gpuData[2] >> 8) & 0x000000ff), (gpuData[4] & 0x000000ff), ((gpuData[4] >> 8) & 0x000000ff),
		               (gpuData[8] & 0x000000ff), ((gpuData[8] >> 8) & 0x000000ff), (gpuData[6] & 0x000000ff),
		               ((gpuData[6] >> 8) & 0x000000ff));
		return;
...
void drawPoly3GT(uint8_t *baseAddr)
{
	uint32_t *gpuData = ((uint32_t *)baseAddr);
...
void drawPoly4GT(uint8_t *baseAddr)
{
	uint32_t *gpuData = ((uint32_t *)baseAddr);
		...
		if (IsNoRect())
		{
			...
			case 0:
				drawPoly4TGEx4_TRI(
				    ...
				    (gpuData[5] & 0x000000ff), ((gpuData[5] >> 8) & 0x000000ff), (gpuData[11] & 0x000000ff),
				    ((gpuData[11] >> 8) & 0x000000ff), (gpuData[8] & 0x000000ff), ((gpuData[8] >> 8) & 0x000000ff),
				    ((gpuData[2] >> 12) & 0x3f0), ((gpuData[2] >> 22) & iGPUHeightMask), gpuData[0], gpuData[3],
				    gpuData[6], gpuData[9]);
...
void DrawSoftwareSpriteMirror(uint8_t *baseAddr, int w, int h)
{
	...
	case 1:
		...
		for (sprCY = 0; sprCY < sprtH; sprCY++)
			for (sprCX = 0; sprCX < sprtW; sprCX++)
			{
				tC = psxVub[((textY0 + (sprCY * lYDir)) << 11) + (GlobalTextAddrX << 1) + textX0 + (sprCX * lXDir)] &
				     0xff;
	...
	case 2:
		...
		if (!bCheckMask && !DrawSemiTrans)
		{
			for (sprCY = 0; sprCY < sprtH; sprCY++)
			{
				...
				if (sprCX == sprtW)
					GetTextureTransColG_S(&psxVuw[sprA], psxVuw[(sprCY << 10) + textX0 + sprCX]);
			}
			return;
		}
		...
		for (sprCY = 0; sprCY < sprtH; sprCY++)
		{
			...
			if (sprCX == sprtW)
				GetTextureTransColG_SPR(&psxVuw[sprA], psxVuw[(sprCY << 10) + textX0 + sprCX]);
		}
		return;
	}
}
